...
const coinSeeds: CoinSeed[] = [
  { ...coinLocalized("europe", "romania", localized("10 бани", "10 бани", "10 bani"), localized("10 бани", "10 бани", "10 bani"), ["2018"]) },
  { ...coinLocalized("europe", "moldova", localized("50 бани", "50 бани", "50 bani"), localized("50 бани", "50 бани", "50 bani"), ["1997"]) },
  { ...coinLocalized("europe", "moldova", localized("25 бани", "25 бани", "25 bani"), localized("25 бани", "25 бани", "25 bani"), ["2011"]) },
  { ...coinLocalized("europe", "latvia", localized("5 сантимов", "5 сантим", "5 santimi"), localized("5 сантимов", "5 сантим", "5 santimi"), ["2009"]) },
  { ...coinLocalized("europe", "ukraine", localized("1 гривна", "1 гривна", "1 hryvnia"), localized("1 гривна", "1 гривна", "1 hryvnia"), ["2001"]) },
  { ...coinLocalized("europe", "france", localized("10 франков Ролан Гаррос", "10 франк Ролан Гаррос", "10 francs Roland Garros"), localized("10 франков", "10 франк", "10 francs"), ["1988"]) },
  { ...coinLocalized("europe", "france", localized("1 франк", "1 франк", "1 franc"), localized("1 франк", "1 франк", "1 franc"), ["1923"]) },
  { ...coinLocalized("europe", "luxembourg", localized("1 франк", "1 франк", "1 franc"), localized("1 франк", "1 франк", "1 franc"), ["1953"]) },
  { ...coinLocalized("europe", "italy", localized("10 лир", "10 лира", "10 lire"), localized("10 лир", "10 лира", "10 lire"), ["1954"]) },
  { ...coinLocalized("europe", "northMacedonia", localized("50 дени", "50 дени", "50 deni"), localized("50 дени", "50 дени", "50 deni"), ["1993"]) },
  { ...coinLocalized("asia", "yemen", localized("20 риалов", "20 риал", "20 rials"), localized("20 риалов", "20 риал", "20 rials"), ["2003"]) },
  { ...coinLocalized("asia", "sriLanka", localized("2 рупии", "2 рупия", "2 rupees"), localized("2 рупии", "2 рупия", "2 rupees"), ["2009"]) },
  { ...coinLocalized("asia", "turkmenistan", localized("1000 манат", "1000 манат", "1000 manat"), localized("1000 манат", "1000 манат", "1000 manat"), ["1999"]) },
  { ...coinLocalized("asia", "bangladesh", localized("10 пойш", "10 пойша", "10 poisha"), localized("10 пойш", "10 пойша", "10 poisha"), ["1994"]) },
  { ...coinLocalized("asia", "kuwait", localized("50 филсов", "50 филс", "50 fils"), localized("50 филсов", "50 филс", "50 fils"), ["1979"]) },
  { ...coinLocalized("asia", "brunei", localized("1 сен", "1 сен", "1 sen"), localized("1 сен", "1 сен", "1 sen"), ["2017"]) },
  { ...coinLocalized("asia", "lebanon", localized("50 ливров", "50 ливр", "50 livres"), localized("50 ливров", "50 ливр", "50 livres"), ["1996"]) },
  { ...coinLocalized("asia", "nepal", localized("1 рупия", "1 рупия", "1 rupee"), localized("1 рупия", "1 рупия", "1 rupee"), ["—"]) },
  { ...coinLocalized("asia", "maldives", localized("5 лаари", "5 лаари", "5 laari"), localized("5 лаари", "5 лаари", "5 laari"), ["2012"]) },
  { ...coinLocalized("northAmerica", "cuba", localized("1 песо", "1 песо", "1 peso"), localized("1 песо", "1 песо", "1 peso"), ["2007"]) },
  { ...coinLocalized("northAmerica", "bahamas", localized("5 центов", "5 цент", "5 cents"), localized("5 центов", "5 цент", "5 cents"), ["2005"]) },
  { ...coinLocalized("northAmerica", "guatemala", localized("25 сентаво", "25 сентаво", "25 centavos"), localized("25 сентаво", "25 сентаво", "25 centavos"), ["2011"]) },
  { ...coinLocalized("northAmerica", "haiti", localized("20 сантимов", "20 сантим", "20 centimes"), localized("20 сантимов", "20 сантим", "20 centimes"), ["1995"]) },
  { ...coinLocalized("northAmerica", "trinidadAndTobago", localized("5 центов", "5 цент", "5 cents"), localized("5 центов", "5 цент", "5 cents"), ["2017"]) },
  { ...coinLocalized("northAmerica", "costaRica", localized("10 колонов", "10 колон", "10 colones"), localized("10 колонов", "10 колон", "10 colones"), ["2012"]) },
  { ...coinLocalized("southAmerica", "bolivia", localized("1 боливиано", "1 боливиано", "1 boliviano"), localized("1 боливиано", "1 боливиано", "1 boliviano"), ["2012"]) },
  { ...coinLocalized("southAmerica", "chile", localized("1 песо", "1 песо", "1 peso"), localized("1 песо", "1 песо", "1 peso"), ["1990"]) },
  { ...coinLocalized("southAmerica", "colombia", localized("50 песо", "50 песо", "50 pesos"), localized("50 песо", "50 песо", "50 pesos"), ["2017"]) },
  { ...coinLocalized("southAmerica", "argentina", localized("1 песо", "1 песо", "1 peso"), localized("1 песо", "1 песо", "1 peso"), ["2009"]) },
  { ...coinLocalized("africa", "angola", localized("100 кванза", "100 кванза", "100 kwanza"), localized("100 кванза", "100 кванза", "100 kwanza"), ["2015"]) },
  { ...coinLocalized("africa", "mozambique", localized("10 метикалов", "10 метикал", "10 meticais"), localized("10 метикалов", "10 метикал", "10 meticais"), ["2006"]) },
  { ...coinLocalized("africa", "mozambique", localized("5000 метикалов", "5000 метикал", "5000 meticais"), localized("5000 метикалов", "5000 метикал", "5000 meticais"), ["1998"]) },
  { ...coinLocalized("africa", "botswana", localized("2 пулы", "2 пула", "2 pula"), localized("2 пулы", "2 пула", "2 pula"), ["2013"]) },
  { ...coinLocalized("africa", "namibia", localized("2 цента", "2 цент", "2 cents"), localized("2 цента", "2 цент", "2 cents"), ["2010"]) },
  { ...coinLocalized("africa", "southAfrica", localized("50 центов", "50 цент", "50 cents"), localized("50 центов", "50 цент", "50 cents"), ["2008"]) },
  { ...coinLocalized("africa", "egypt", localized("1 фунт с фараоном", "1 фунт перғауынмен", "1 pound with pharaoh"), localized("1 фунт", "1 фунт", "1 pound"), ["—"]) },
  { ...coinLocalized("africa", "zambia", localized("50 нгве", "50 нгве", "50 ngwee"), localized("50 нгве", "50 нгве", "50 ngwee"), ["2012"]) },
  { ...coinLocalized("africa", "kenya", localized("20 шиллингов", "20 шиллинг", "20 shillings"), localized("20 шиллингов", "20 шиллинг", "20 shillings"), ["1998"]) },
  { ...coinLocalized("africa", "uganda", localized("5 шиллингов", "5 шиллинг", "5 shillings"), localized("5 шиллингов", "5 шиллинг", "5 shillings"), ["1987"]) },
  { ...coinLocalized("africa", "malawi", localized("1 тамбала", "1 тамбала", "1 tambala"), localized("1 тамбала", "1 тамбала", "1 tambala"), ["1995"]) },
  { ...coinLocalized("africa", "eritrea", localized("1 цент", "1 цент", "1 cent"), localized("1 цент", "1 цент", "1 cent"), ["1997"]) },
  { ...coinLocalized("africa", "seychelles", localized("1 цент", "1 цент", "1 cent"), localized("1 цент", "1 цент", "1 cent"), ["2014"]) },
  { ...coinLocalized("oceania", "australia", localized("1 доллар", "1 доллар", "1 dollar"), localized("1 доллар", "1 доллар", "1 dollar"), ["2005"]) },
  { ...coinLocalized("oceania", "vanuatu", localized("10 вату", "10 вату", "10 vatu"), localized("10 вату", "10 вату", "10 vatu"), ["2004"]) },
  { ...coinLocalized("oceania", "samoa", localized("10 сене", "10 сене", "10 sene"), localized("10 сене", "10 сене", "10 sene"), ["2011"]) },
  { ...coinLocalized("oceania", "tonga", localized("5 сенити", "5 сенити", "5 seniti"), localized("5 сенити", "5 сенити", "5 seniti"), ["2015"]) },
  { ...kazakhstanThemedCoin("kazakhstanHistory", "Полигон", "Полигон", "Polygon", "100 тенге", "100 теңге", "100 tenge", "2021") },
  { ...historicalCoinLocalized("ussr", localized("1 копейка", "1 тиын", "1 kopeck"), localized("1 копейка", "1 тиын", "1 kopeck"), ["1968"]) },
  { ...specialTerritoryCoinLocalized("gibraltar", localized("5 пенсов", "5 пенс", "5 pence"), localized("5 пенсов", "5 пенс", "5 pence"), ["2003"]) },
  { ...specialTerritoryCoinLocalized("tokelau", localized("1 цент", "1 цент", "1 cent"), localized("1 цент", "1 цент", "1 cent"), ["2017"]) },
  { ...specialTerritoryCoinLocalized("cookIslands", localized("1 цент", "1 цент", "1 cent"), localized("1 цент", "1 цент", "1 cent"), ["2017"]) },
  { ...specialTerritoryCoinLocalized("macau", localized("50 авос", "50 авос", "50 avos"), localized("50 авос", "50 авос", "50 avos"), ["1993"]) },
  { ...specialTerritoryCoinLocalized("somaliland", localized("1 шиллинг", "1 шиллинг", "1 shilling"), localized("1 шиллинг", "1 шиллинг", "1 shilling"), ["1994"]) },
...
const banknoteImageOverrides: Record<string, BanknoteImageOverride> = {
  ...
  "banknote|bosniaAndHerzegovina|10 динар|—": banknoteImageSet("/images/banknotes/bosnia-and-herzegovina/bosnia-and-herzegovina-10-dinars"),
